...
class IssueFilter(django_filters.FilterSet):
    cover_year = django_filters.NumberFilter(field_name="cover_date", lookup_expr="year")
    cover_month = django_filters.NumberFilter(field_name="cover_date", lookup_expr="month")
